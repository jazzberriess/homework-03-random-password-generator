...
function generatePassword() {
  ...
  let passwordLength = Number(Prompt("Please choose the length of your password between 8 and 128 characters."));

  if ((passwordLength < 8) || (passwordLength > 128)); {

    window.alert("Invalid input. You must choose between 8 and 128 characters.");
    generatePassword();
