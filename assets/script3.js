...
function generatePassword() {
    ...
    //Big thank you to Italy S for posting a similar solution on stackoverflow. I was stuck for hours on this because I wanted a more concise way of creating an array based on the user requirements: https://stackoverflow.com/questions/69851109/js-password-generator-character-length-not-working
    ...
    //all of the below if/else statements are so that any password that is true for all 4 criteria will have at least one character of each category in the password. Otherwise, the password will only have characters from the requested criteria.
